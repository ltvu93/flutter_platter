...
class PageTransformer extends StatefulWidget {
  ...
  final Function(PageVisibilityResolver) onPageScrolling;

  PageTransformer({this.pageView, this.onPageScrolling});
  ...
  Widget build(BuildContext context) {
    return NotificationListener<ScrollNotification>(
      onNotification: (ScrollNotification notification) {
        if (widget.onPageScrolling != null) {
          double viewPortFraction = widget.pageView.controller.viewportFraction;

          widget.onPageScrolling(PageVisibilityResolver(
